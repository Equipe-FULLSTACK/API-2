...
public class Inicio {
	static void definirInicio(int width, int height){
		...
		Menu.definirCombo  (Menu.combo_atualizar_entrega,            Menu.pct(width,  2), Menu.pct(height, 58), Menu.pct(width, 12), Menu.pct(height,  5), Menu.fonteLista);
		...
		Menu.definirTxtArea(Menu.panel_txtarea_atualizar_comentario, Menu.pct(width,  2), Menu.pct(height, 64), Menu.pct(width, 17), Menu.pct(height, 19), Menu.fonteLista, Menu.scroll_txtarea_atualizar_comentario, Menu.txtarea_atualizar_comentario);
		...
		Menu.definirLbl    (Menu.lbl_aulas_dia,                      Menu.pct(width, 69), Menu.pct(height, 18), Menu.pct(width, 18), Menu.pct(height,  8), Menu.fonteBtnTopo);
		Menu.definirLbl    (Menu.lbl_horario,                        Menu.pct(width, 87), Menu.pct(height, 18), Menu.pct(width,  8), Menu.pct(height,  8), Menu.fonteBtnTopo);
		Menu.definirDate   (Menu.datepicker_inicio,                  Menu.pct(width, 68), Menu.pct(height, 26), Menu.pct(width, 29), Menu.pct(height,  5), Menu.fonteLista);
